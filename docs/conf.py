...
latex_documents = [
    (master_doc, 'fairyfly.tex', 'Fairyfly Documentation',
...
man_pages = [
    (master_doc, 'fairyfly', 'Fairyfly Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fairyfly', 'Fairyfly Documentation',
     author, 'fairyfly', 'One line description of project.',
     'Miscellaneous'),
]
